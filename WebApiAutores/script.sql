...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230701161022_Inicial')
BEGIN
...
BEGIN
    ...
    VALUES (N'20230701161022_Inicial', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230701195117_Comentarios')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230701195117_Comentarios', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230702164807_AutoresLibros')
BEGIN
    ALTER TABLE [comentarios] DROP CONSTRAINT [FK_comentarios_Libros_LibroId];
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230702164807_AutoresLibros')
BEGIN
    ALTER TABLE [comentarios] DROP CONSTRAINT [PK_comentarios];
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230702164807_AutoresLibros')
BEGIN
    EXEC sp_rename N'[comentarios]', N'Comentarios';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230702164807_AutoresLibros')
BEGIN
    EXEC sp_rename N'[Comentarios].[IX_comentarios_LibroId]', N'IX_Comentarios_LibroId', N'INDEX';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230702164807_AutoresLibros', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230703022949_FechaPublicacionLibro')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230703022949_FechaPublicacionLibro', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230703194242_SistemaUsuarios')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230703194242_SistemaUsuarios', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230703214338_ComentarioUsuario')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230703214338_ComentarioUsuario', N'6.0.2');
END;
GO
